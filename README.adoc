...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/carloswsilva007/sistema-bancario/maven[GitHub Workflow Status]
